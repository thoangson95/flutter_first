...
abstract class $RatingModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String sao, String solan});
}
...
class _$_RatingModel implements _RatingModel {
  const _$_RatingModel({required this.sao, required this.solan});
  ...
  @override
  String toString() {
    return 'RatingModel(sao: $sao, solan: $solan)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, sao, solan);
...
abstract class _RatingModel implements RatingModel {
  const factory _RatingModel(
      ...
      required final String solan}) = _$_RatingModel;

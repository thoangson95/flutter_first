...
class ForgetCodePage extends ConsumerStatefulWidget {
  const ForgetCodePage({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _ForgetCodePageState();
}

class _ForgetCodePageState extends ConsumerState<ForgetCodePage> {
  ...
  Widget build(BuildContext context) {
    final phoneState = ref.watch(userProviders);

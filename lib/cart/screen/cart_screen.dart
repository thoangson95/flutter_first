  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer(builder: (context, ref, child) {
        final data = ref.watch(cartChangeProvider).list;
          ...
          children: [
            Consumer(
              builder: (context, ref, child) {
                final isCheckAll = ref.watch(cartChangeProvider).isSelectAll;
                return Row(
                  children: [
                    Container(
                      width: 24,
                      ...
                      child: Checkbox(
                        ...
                        value: isCheckAll,
                        onChanged: (value) {
                          ref.read(cartChangeProvider.notifier).selecteAll();
                        },
                      ),
                    ),
                    const Text(
            ...
            Consumer(
              builder: (context, ref, child) {
                final total = ref.watch(cartChangeProvider).total;
                final qty = ref.watch(cartChangeProvider).maxQty;
                return Column(
                  crossAxisAlignment: CrossAxisAlignment.center,
